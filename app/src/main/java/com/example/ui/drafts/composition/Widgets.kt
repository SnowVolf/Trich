...
import com.example.ui.history.composition.dateFormat
...
fun DraftItem(
    ...
    Card(
        ...
        border = androidx.compose.foundation.BorderStroke(
            ...
            if (isSelected) MaterialTheme.colorScheme.primary else androidx.compose.ui.graphics.Color(0x0AFFFFFF)
        )
    ) {
