...
import com.example.ui.history.composition.HistoryItem
    ...
    Scaffold(
        ...
        Box(modifier = Modifier.fillMaxSize().padding(bottom = padding.calculateBottomPadding())) {
            if (state.isLoading) {
                ...
                Text(stringResource(R.string.history_empty), modifier = Modifier.align(Alignment.Center).padding(top = padding.calculateTopPadding()))
            } else {
                LazyColumn(
