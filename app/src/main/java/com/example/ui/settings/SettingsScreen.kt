    ...
    Scaffold(
        ...
        Box(modifier = Modifier.fillMaxSize().padding(bottom = padding.calculateBottomPadding())) {
            Column(modifier = Modifier
                ...
                Text(stringResource(R.string.settings_passcode_title), style = MaterialTheme.typography.titleMedium)
                ...
                Button(
                    ...
                    Text(if (state.passcodeActivated) stringResource(R.string.settings_passcode_active) else stringResource(R.string.settings_passcode_activate))
                }
