...
import ru.svolf.trich.model.CaptchaIdResponse
import ru.svolf.trich.model.EmojiCaptchaShowResponse
import ru.svolf.trich.model.ThreadInfoResponse
...
interface DvachApi {
    ...
    ): ru.svolf.trich.model.CatalogResponse
    ...
    ): ru.svolf.trich.model.ThreadPostsMakabaResponse
    ...
    suspend fun clickEmojiCaptcha(
        @Body request: ru.svolf.trich.model.EmojiCaptchaClickRequest,
    ): EmojiCaptchaShowResponse
    ...
    ): ru.svolf.trich.model.PostingResponse
}
